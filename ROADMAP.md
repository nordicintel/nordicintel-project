...
Current work focuses on independently runnable local adapter repositories. Hosted harvesting workers remain deferred. The [retrieval contract decision](docs/architecture.md#retrieval-contract-and-packaging) (2026-09-25) settles the retrieval interface and packaging. The broad development sequence is integrations, searchable catalog, then website and public API access.
...
- Define local artifact packaging, file-tracking formats, and the separate validation/import contract. Reuse the established Dataset document shape, including file-backed observations, and its consumer semantic checks.
